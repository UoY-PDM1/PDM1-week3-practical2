...
export class TestResults {
    ...
    static display(div) {
        ...
        this.#createResultSection(div, this.passed, "Checks passed:", "&#x2713;");
        this.#createResultSection(div, this.failed, "Checks failed:", "&#10060;");
        this.#createResultSection(div, this.warnings, "Warnings:", "&#9888;");
    }
